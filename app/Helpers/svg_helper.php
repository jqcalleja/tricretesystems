 ...
 */
// ============================================================
// LOGO MARK (the T-shield chevron mark)
// ============================================================

/**
 * Returns the Tricrete "T" chevron mark as inline SVG.
 * Icon-only version (no wordmark).
 *
 * @param string $class  CSS class(es) to apply to the <svg> element
 * @param string $size   Width of the mark. Height auto-scales (~1.14 ratio).
 */
function svg_logo_mark(string $class = '', string $size = '32'): string
{
    ...
    return <<<SVG
<svg width="{$s}" height="{$s}" viewBox="0 0 240 210"
     xmlns="http://www.w3.org/2000/svg"
     class="{$c}" aria-label="Tricrete" role="img">
  <g fill="#EE2B2B">
    <polygon points="10,20 120,52 230,20 230,32 120,64 10,32"/>
    <polygon points="30,39 120,71 210,39 210,51 120,83 30,51"/>
    <polygon points="50,58 120,90 190,58 190,70 120,102 50,70"/>
    <polygon points="80,102 112,102 116,200"/>
    <polygon points="160,102 128,102 124,200"/>
  </g>
</svg>
SVG;
}
...
/**
 * Returns the full Tricrete Systems logo: T-mark + wordmark beside it.
 *
...
function svg_logo(string $class = '', string $height = '40', bool $dark = false): string
{
    ...
    // Canvas: mark ~240x210, gap, then wordmark area
    return <<<SVG
<svg width="auto" height="{$h}" viewBox="0 0 660 210"
     xmlns="http://www.w3.org/2000/svg"
  ...
  <text x="270" y="118"
        ...
        letter-spacing="2">TRICRETE</text>
  ...
  <text x="273" y="168"
        ...
        font-size="34"
        fill="{$sub}"
        letter-spacing="10">SYSTEMS</text>
