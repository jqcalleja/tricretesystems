        ...
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <textarea name="spouse_address" class="form-control form-control-sm"
                    rows="2"><?= esc(old('spouse_address')) ?></textarea>
            </div>
        </div>
    </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-12 col-md-8">
                ...
                <textarea name="parents_address" class="form-control form-control-sm"
                    rows="2"><?= esc(old('parents_address')) ?></textarea>
            </div>
        </div>
    </div>
